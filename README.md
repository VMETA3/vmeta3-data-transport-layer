...
`L1_TRANSPORT__L1_RPC_ENDPOINT` can be the JSON RPC endpoint of any L1 Ethereum node. `L1_TRANSPORT__ADDRESS_MANAGER` should be the contract addresss of the Address Manager on the corresponding network; find their values in the [contracts package](https://github.com/VMETA3/vmeta3-chain/vmeta3/tree/develop/packages/contracts/deployments).
...
| DATA_TRANSPORT_LAYER__ADDRESS_MANAGER                   | -           | Address of the AddressManager contract on L1. See [contracts](https://github.com/VMETA3/vmeta3-chain/vmeta3/tree/develop/packages/contracts/deployments) package to find this address for mainnet or kovan. |
