/* Imports: External */
import { fromHexString, sleep } from '@vmeta3/core-utils'
import { BaseService, Metrics } from '@vmeta3/common'
import { TypedEvent } from '@vmeta3/contracts/dist/types/common'
...
export class L1IngestionService extends BaseService<L1IngestionServiceOptions> {
  ...
  protected async _init(): Promise<void> {
    ...
    this.state.contracts = await loadVmeta3Contracts(
      this.state.l1RpcProvider,
      this.options.addressManager
    )
