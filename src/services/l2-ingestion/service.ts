...
import { getChainId, sleep, toRpcHexString } from '@vmeta3/core-utils'
    ...
    while (this.running) {
      try {
        ...
        if (
          ...
          this.logger.info(
            'All Layer 2 (Vmeta3) transactions are synchronized',
            {
              currentL2Block,
              targetL2Block,
            }
        ...
        this.logger.info(
          'Synchronizing unconfirmed transactions from Layer 2 (Vmeta3)',
          {
