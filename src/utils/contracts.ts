...
import { getContractInterface } from '@vmeta3/contracts'
...
export interface Vmeta3Contracts {
  Lib_AddressManager: Contract
  StateCommitmentChain: Contract
  CanonicalTransactionChain: Contract
}

export const loadVmeta3Contracts = async (
  l1RpcProvider: BaseProvider,
  addressManagerAddress: string,
  signer?: Signer
): Promise<Vmeta3Contracts> => {
  ...
  // TODO: sorry
  return contracts as Vmeta3Contracts
}
